...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/venn17-sector.jpg}
\caption{One of the seventeen congruent sectors of the 17-curve diagram \texttt{c178d7bd}, unrolled into a strip: a
fundamental domain of the rotation, containing $131{,}070/17 = 7{,}710$ of the crossings. The whole diagram is this
strip repeated seventeen times around the centre.}
\label{fig:sector}
\end{figure}
\section{Properties}
