...
known only up to 13 curves (Mamakani and Ruskey, 2014). Four 17-curve and six 19-curve diagrams were found by a Metropolis walk on
...
\caption{One of the six 19-curve diagrams (certificate \texttt{fcb7ad34}), drawn from its certificate at near-uniform
...
\bottomrule
\end{tabular}
\caption{The ten certificates. Within each size the diagrams are pairwise non-isomorphic under cyclic relabelling of
the curves, mirror image and exchange of the two poles (canonical forms compared over all $4n$ such maps); as face
sets the six 19-curve certificates differ pairwise by between $25{,}460$ and $827{,}716$ faces of $524{,}286$.}
\end{table}
