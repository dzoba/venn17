...
def meridianEnd : MeridianParameter := ⟨19, by norm_num⟩
...
theorem meridianCircleParameter_end : meridianCircleParameter meridianEnd = -1 := by
  rw [meridianCircleParameter_exp]
  have he : Real.pi / 19 * meridianEnd.val = Real.pi := by simp [meridianEnd]
  rw [he]
  apply Circle.ext
...
theorem diagramMeridianMap_eq_iff (k l : Fin 19) (t u : MeridianParameter) :
  ...
  · intro h
    ...
    have he : diagramMeridianMap k t ∈ {patternPoint 0, patternPoint 524287} :=
...
def rigidMeridianMap (k : Fin 19) (t : MeridianParameter) : SphereRepresentative :=
  sphereMeridianBoundary (rigidDirection k) (rigidDirection (cyclicNext k)) (meridianCircleParameter t)

theorem rigidMeridianMap_val (k : Fin 19) (t : MeridianParameter) :
...
theorem rigidMeridianMap_horizontal (k : Fin 19) (t : MeridianParameter) :
...
theorem rigidMeridianMap_vertical (k : Fin 19) (t : MeridianParameter) :
    vertical (rigidMeridianMap k t).val = (meridianCircleParameter t : ℂ).re := by
  rw [rigidMeridianMap_val, vertical_fromHorizontal]

theorem sphereMeridianBoundary_front (k l : Fin 19) (t : MeridianParameter) :
...
theorem sphereMeridianBoundary_back (k l : Fin 19) (t : MeridianParameter) :
    sphereMeridianBoundary (rigidDirection k) (rigidDirection l) (meridianCircleParameter t)⁻¹ =
...
theorem rigidMeridianMap_eq_iff (k l : Fin 19) (t u : MeridianParameter) :
...
theorem meridian_parameter_compatibility (k l : Fin 19) (t u : MeridianParameter) :
