...
theorem diagram_region_field_ne_zero (i : Fin 19) (v : Fin 524288)
...
certified pattern. -/
theorem diagram_region_field_sign (i : Fin 19) (v : Fin 524288)
...
theorem diagram_region_positive_iff (i : Fin 19) (v : Fin 524288)
    {x : Diagram} (hx : x ∈ diagramRegion v) :
