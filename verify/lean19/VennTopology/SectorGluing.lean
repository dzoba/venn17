...
def SectorBoundaryCompatibility : Prop :=
  ∀ (k l : Fin 19) (z w : UnitCircle),
    sectorBoundaryParam k z = sectorBoundaryParam l w ↔
      rigidSectorParam k z = rigidSectorParam l w

theorem sectorConjugacy_agrees (h : SectorBoundaryCompatibility) (k l : Fin 19)
...
theorem sectorConjugacy_symm_agrees (h : SectorBoundaryCompatibility) (k l : Fin 19)
...
theorem sphere_conjugacy_of_boundary_compatibility (h : SectorBoundaryCompatibility) :
  ...
  let u : Finset (Fin 19) := Finset.univ
  ...
  have hv (k : Fin 19) (x : Diagram) (hx : x ∈ diagramSector k) :
