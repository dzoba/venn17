...
def sectorConjugacy (k : Fin 19) : diagramSector k ≃ₜ rigidSector k :=
  (equivariantSectorDisk k).trans (equivariantRigidSectorDisk k).symm

theorem sectorConjugacy_coordinates (k : Fin 19) (x : diagramSector k) :
...
theorem sectorConjugacy_boundary (k : Fin 19) (z : UnitCircle) :
    (sectorConjugacy k
...
theorem sectorConjugacy_symm_boundary (k : Fin 19) (z : UnitCircle) :
...
theorem sectorConjugacy_rotation (k : Fin 19) (x : diagramSector k) :
...
theorem sectorwise_rigid_conjugacy :
    ∃ E : ∀ k : Fin 19, diagramSector k ≃ₜ rigidSector k,
