...
def diagramBitField (i : Fin 19) (x : Diagram) : ℝ := diagramQuad.bitField 524288 i.val x.val

theorem diagramBitField_continuous (i : Fin 19) : Continuous (diagramBitField i) :=
  (diagramQuad.bitField_continuous 524288 i.val).comp continuous_subtype_val

theorem diagramBitField_pattern (i : Fin 19) (v : Fin 524288) :
    diagramBitField i (patternPoint v) = bitSign i.val v.val :=
  diagramQuad.bitField_region 524288 i.val v.val v.isLt
