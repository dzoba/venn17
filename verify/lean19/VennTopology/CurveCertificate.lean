...
theorem each_curve_polygon_verified (i : Fin 19) :
    CurveProof.check suppliedModel.oriented 524288 i.val
      (suppliedCurvePolygons.getD i.val default) = true ∧
    (suppliedCurvePolygons.getD i.val default).vertices.size = 110376 := by
