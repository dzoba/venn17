...
theorem diagram_curve_field_zero (i : Fin 19) (x : Diagram) (hx : x ∈ diagramCurve i) :
  ...
  have hc : diagramQuad.faceSign i.val f = 0 := by
    ...
    · exact hc.1
  exact diagramQuad.bitField_arm_zero 524288 i.val f
...
theorem diagram_field_zero_curve (i : Fin 19) (x : Diagram) (hx : diagramBitField i x = 0) :
    x ∈ diagramCurve i := by
  ...
  change diagramQuad.bitField 524288 i.val x.val = 0 at hx
  rw [hx] at hf
...
theorem diagram_curve_iff_field_zero (i : Fin 19) (x : Diagram) :
...
theorem diagram_bit_field_verified (i : Fin 19) :
    Continuous (diagramBitField i) ∧
    (∀ v : Fin 524288, diagramBitField i (patternPoint v) = bitSign i.val v.val) ∧
