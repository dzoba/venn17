...
theorem diagramCurve_original (i : Fin 19) (x : Diagram) :
    x ∈ diagramCurve i ↔ x.val ∈ diagramQuad.edgeCurve i.val := by
  change Coordinates.reindex (Coordinates.labelEquiv 524288 suppliedModel.oriented.size) x.val ∈
    encodedCurve suppliedModel.oriented 524288 i.val ↔ _
