...
#guard (parsePattern 17 (.str "10000000000000000")).toOption == some 1
#guard (parsePattern 17 (.str "00000000000000001")).toOption == some (2^16)
#guard rotate 1 == 2^16
#guard rotate 2 == 1
...
-- An actual 17-element face orbit passes; incomplete or reversed orbits fail.
private def squareOrbit : Array Face :=
  (Array.range 17).map fun n => #[0, 1, 3, 2].map (steps regionStep n)
