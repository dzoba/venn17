...
def planeCurve (e : PuncturedDiagram ≃ₜ Plane) (i : Fin 17) : Set Plane := e '' puncturedCurve i
def planeSide (e : PuncturedDiagram ≃ₜ Plane) (i : Fin 17) (b : Bool) : Set Plane := e '' puncturedSide i b
def planeRegion (e : PuncturedDiagram ≃ₜ Plane) (v : Fin 131072) : Set Plane := e '' puncturedRegion v

theorem diagramBitField_zero_pattern (i : Fin 17) : diagramBitField i (patternPoint 0) = -1 := by
...
theorem punctured_nonnegative_compact (i : Fin 17) :
...
theorem planeSide_true_bounded (e : PuncturedDiagram ≃ₜ Plane) (i : Fin 17) :
...
theorem puncturedCurve_compact (i : Fin 17) : IsCompact (puncturedCurve i) := by
...
theorem planeSide_false_unbounded (e : PuncturedDiagram ≃ₜ Plane) (i : Fin 17) :
...
theorem planeRegion_eq_sides (e : PuncturedDiagram ≃ₜ Plane) (v : Fin 131072) :
    planeRegion e v = ⋂ i : Fin 17, planeSide e i (v.val.testBit i.val) := by
  unfold planeRegion planeSide
  rw [puncturedRegion_eq_sides,image_iInter e.bijective]

theorem planeRegion_pathConnected (e : PuncturedDiagram ≃ₜ Plane) (v : Fin 131072) :
    IsPathConnected (planeRegion e v) := (puncturedRegion_pathConnected v).image e.continuous

theorem plane_curves_are_embedded_circles (e : PuncturedDiagram ≃ₜ Plane) (i : Fin 17) :
...
theorem plane_curve_complement_component_count (e : PuncturedDiagram ≃ₜ Plane) (i : Fin 17) :
...
theorem plane_complement_unique_region (e : PuncturedDiagram ≃ₜ Plane) (x : Plane) :
    x ∉ ⋃ i : Fin 17, planeCurve e i ↔ ∃! v : Fin 131072, x ∈ planeRegion e v := by
...
theorem all_bit_patterns (b : Fin 17 → Bool) :
    ∃ v : Fin 131072, ∀ i : Fin 17, v.val.testBit i.val = b i := by
  have h : Function.Bijective (fun v : Fin 131072 => fun i : Fin 17 => v.val.testBit i.val) := by
...
theorem plane_every_membership_pattern (e : PuncturedDiagram ≃ₜ Plane) (b : Fin 17 → Bool) :
    IsPathConnected (⋂ i : Fin 17, planeSide e i (b i)) := by
...
theorem planar_sides_verified (e : PuncturedDiagram ≃ₜ Plane) :
    ...
    (∀ v : Fin 131072, IsPathConnected (planeRegion e v) ∧
      planeRegion e v = ⋂ i : Fin 17, planeSide e i (v.val.testBit i.val)) ∧
    (∀ x : Plane, x ∉ ⋃ i : Fin 17, planeCurve e i ↔ ∃! v : Fin 131072, x ∈ planeRegion e v) ∧
    (∀ b : Fin 17 → Bool, IsPathConnected (⋂ i : Fin 17, planeSide e i (b i))) :=
