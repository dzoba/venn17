...
theorem meridian_boundary_parameter_compatibility (k l a b : Fin 17) (z w : Circle) :
...
theorem rigidSphereConjugacy_sector (k : Fin 17) (x : Diagram) (hx : x ∈ diagramSector k) :
...
theorem rigidSphereConjugacy_boundary (k : Fin 17) (z : UnitCircle) :
...
theorem rigidSphereConjugacy_meridian (k : Fin 17) (t : MeridianParameter) :
...
theorem rigidSphereConjugacy_one : rigidSphereConjugacy (patternPoint 131071) = rigidSouth := by
  have h := rigidSphereConjugacy_meridian 0 meridianEnd
  rw [show diagramMeridianMap 0 meridianEnd = patternPoint 131071 from diagramMeridianMap_one 0] at h
  exact h
