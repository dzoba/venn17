...
theorem diagram_presentation_edge_count : diagramPresentation.edgeCount = 786420 := by
  change Fintype.card diagramFiniteTriangulation.Edge = _
  rw [Fintype.card_coe]
  exact diagram_finite_edge_count

theorem diagram_presentation_face_count : diagramPresentation.faces.length = 524280 := by
