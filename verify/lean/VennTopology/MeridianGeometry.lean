...
theorem meridian_boundary_subset_realization (k l : Fin 17) :
    labeledPolygon (meridianBoundaryLabel k l) ⊆
      Coordinates.realization (encodedCells suppliedModel.oriented 131072) := by
  intro x hx
...
def diagramMeridianBoundary (k l : Fin 17) : Set Diagram :=
  {x | (diagramEncodedHomeomorph x).val ∈ labeledPolygon (meridianBoundaryLabel k l)}

def diagramMeridianBoundaryMap (k l : Fin 17) (z : Circle) : Diagram :=
...
theorem diagramMeridianBoundaryMap_continuous (k l : Fin 17) :
...
theorem diagramMeridianBoundaryMap_injective (k l : Fin 17) (hkl : k ≠ l) :
...
theorem diagramMeridianBoundaryMap_range (k l : Fin 17) :
...
theorem diagram_meridian_boundaries_are_circles (k l : Fin 17) (hkl : k ≠ l) :
...
theorem diagramMeridianBoundaryMap_rotation (k l : Fin 17) (z : Circle) :
...
theorem diagram_meridian_boundary_rotation (k l : Fin 17) :
