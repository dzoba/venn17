# Checker transcript, 19-curve certificates (2026-09-21)

`python3 verify/verify.py certificates/<file>` on each of the six 19-curve certificates, followed by `verify/monotone_test.py`.
